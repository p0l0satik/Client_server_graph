...
Каждый серверный контейнер может единовременно корректно обработать один клиентский контейнер.
...
5. Вычисление пути:
    ...
    - введите `7` чтобы рассчитать путь в режиме сравнения(вы получите результаты рассчетов с помощью двух алгоритмов и скорость их работы)
